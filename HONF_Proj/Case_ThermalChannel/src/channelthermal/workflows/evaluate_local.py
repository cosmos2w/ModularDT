...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--saved-root", type=str, default="./Trained_Results/ThermalChannel/Local_Module_Runs/thermal_disk", help="Root directory containing local saved-model runs.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    dataset_path = args.dataset or dataset_cfg.get("packed_h5_path", "./Case_ThermalChannel/Dataset/links/thermal_disk_local_v1.h5")
