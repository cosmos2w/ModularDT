...
from honf_runtime.compat import decode_string_array, resolve_demo_path, safe_std_np


LOCAL_DATASET_PATH = "./Case_ThermalChannel/Dataset/links/thermal_disk_local_v1.h5"
GLOBAL_DATASET_PATH = "./Case_ThermalChannel/Dataset/links/thermal_channel_global_v1.h5"
