...
def resolved_payload_for_ablation(base_payload: Dict[str, Any], ablation: AblationConfig) -> Dict[str, Any]:
    ...
    optional_model_fields = (
        ...
        "use_hyper_value_context",
        "mechanism_include_geometry",
        "mechanism_include_masses",
        "mechanism_hidden_dim",
        "hyper_module_assignment_mode",
        "hyper_query_attention_mode",
        "hyper_attention_topk",
        "hyper_attention_temperature",
        "sparse_hyper_attention_detach_mask",
