...
and loss config dictionaries. Outputs are scalar PyTorch losses for
global-field HONF-CL training. This module is specific to ChannelThermal field
...
def weighted_field_mse(
    ...
    """Compute channel-weighted field MSE with optional per-query weights."""
