"""CHANNELTHERMAL-SPECIFIC local module datasets.

Inputs are the existing packed local-module and global-alignment HDF5 files.
Outputs are Stage-A sample dictionaries containing module parameters, port
tokens, local disk query points, internal temperature targets, and interface
targets. This module is ChannelThermal-specific and preserves legacy
normalization and split behavior.
"""
