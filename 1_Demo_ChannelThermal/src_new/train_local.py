"""CHANNELTHERMAL-SPECIFIC Stage-A local surrogate trainer.

Inputs are a local-module training config and existing packed Stage-A/global
alignment HDF5 files. Outputs are local surrogate checkpoints and loss curves.
This executable is ChannelThermal-specific and preserves the old checkpoint
schema for compatibility with previous Stage-B/global runs.
"""
...
from _data.local_module_datasets import GlobalModuleAlignmentDataset, LocalModuleDataset
...
DEFAULT_CONFIG_PATH = "./Configs_new/train_local_module_template.json"
